<div id="Tabelabanner">
    ...
    <div class="tabela">    
        ...
        <div class="mini_tabela">
            <div class="coluna_bloco">
                    <div class="primeiro_bloco">
                        <img src="imagens/image-01-mega.png" alt="">
                        <label for="" class="preco">R$00,00</label>
                        <button class="btn_contratar">CONTRATAR</button>
                    </div>
                    <div class="segundo_bloco">
                        <img src="imagens/image-02-mega.png" alt="">
                        <label for="" class="preco">R$00,00</label>
                        <button class="btn_contratar">CONTRATAR</button>
                    </div>
                    <div class="terceiro_bloco">
                        <img src="imagens/image-04-mega.png" alt="">
                        <label for="" class="preco">R$00,00</label>
                        <button class="btn_contratar">CONTRATAR</button>
                    </div>
            </div>
            <div class="coluna_bloco">
                <div class="primeiro_bloco">
                    <img src="imagens/image-08-mega.png" alt="">
                    <label for="" class="preco">R$00,00</label>
                    <button class="btn_contratar">CONTRATAR</button>
                </div>
                <div class="segundo_bloco">
                    <img src="imagens/image-10-mega.png" alt="">
                    <label for="" class="preco">R$00,00</label>
                    <button class="btn_contratar">CONTRATAR</button>
                </div>
                <div class="terceiro_bloco">
                    <img src="imagens/image-20-mega.png" alt="">
                    <label for="" class="preco">R$00,00</label>
                    <button class="btn_contratar">CONTRATAR</button>
                </div>
            </div>
